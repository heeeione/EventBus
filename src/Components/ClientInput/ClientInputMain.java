...
public class ClientInputMain {
		...
		while (!done) {
			...
			try {
				...
				case "6":
					...
					break;
				case "7":
					eventBus.sendEvent(new Event(EventId.Enrolment, enrolment()));
					printLogSend(EventId.Enrolment);
					break;
				case "0":
	...
	private static String enrolment() throws IOException {
		String userInput = "";
	...
	private static void writeMenu() {
		...
		System.out.println("7. Enrolment");
		System.out.println("0. Quit the system");
		System.out.print("\n Choose No.: ");
	}
	private static void printLogSend(EventId eventId) { System.out.println("\n** Sending an event(ID:" + eventId + ")\n"); }
}
